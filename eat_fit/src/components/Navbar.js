...
import EatNowCategory from './eatnow'
import EatLaterCategory from './eatlater'
                    ...
                    <BrowserRouter>
                        <nav className="navbar navbar-expand-lg navbar-light bg-light ">
                            ...
                            <form class="form-inline">
                                {/* <p><small>Ulsoor</small></p> */}
                                <img src="https://image.flaticon.com/icons/svg/1000/1000997.svg" style={{width:30, height:30, marginLeft:10}}></img>
                                <a className="nav-item nav-link">Login</a>
                                <img src="https://image.flaticon.com/icons/svg/60/60992.svg" style={{width:30, height:30, marginLeft:10}}></img>
                            </form>
                        </nav>
                            <div>
                        ...
                        <Route path="/eatnow" exact component={EatNowCategory}></Route>
                        <Route path="/eatlater" component={EatLaterCategory}></Route>
